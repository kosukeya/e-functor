...
def run(
    ...
    plots_dir = out_dir / out_plots_dir
...
def main(argv=None):
    ...
    ap.add_argument("--out-csv", type=str, default="island_env_error.csv")
    ap.add_argument("--out-plots-dir", type=str, default="island_env_error_plots")
