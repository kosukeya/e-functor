...
def run_island_eps(
    ...
    prev_lab = _ensure_labels(prev, k=k, use_attn=use_attn, seed=seed)
    ...
    for cur in snaps[1:]:
        cur_lab = _ensure_labels(cur, k=k, use_attn=use_attn, seed=seed)
...
def main(argv=None):
    ...
    ap.add_argument("--out-csv", type=str, default="island_eps_summary.csv")
